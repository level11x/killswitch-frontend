    ...
    return (
        <div className="w-full h-screen overflow-y-auto overflow-x-hidden relative pt-nav bg-primary">
            ...
            <div className="w-full px-md relative bg-gradient-to-b from-[#000044]">
                ...
                <HomeBanner mobile className="md:hidden absolute transform right-0 h-1/2 scale-[2] object-right-bottom -translate-x-32 bottom-0"/>
                <div className="w-full container mx-auto max-w-screen-xl h-screen-nav relative md:py-4xl" >
                    <div className="flex flex-col space-y-8 items-start py-md">
                        <div className="text-white space-y-xl">
                            ...
                            <p className="leading-relaxed">The shirt auction free of NFT will be auctioned for 3 days with a special prize when the bid is reached.</p>
                        </div>
                        <div className="hidden md:flex flex-col md:flex-row mmd:space-y-sm md:space-x-lg">
                            <button className="px-3 py-3 rounded font-bold text-white text-xl bg-[#00BCD4]">Start Auction</button>
                            <button className="px-3 py-3 rounded font-bold text-xl border text-[#00BCD4] border-[#00BCD4]">KillSwitch.finance</button>
                        </div>
                    </div>
                </div>
            </div>
            <div className="relative py-4xl space-y-lg z-10 overflow-visible">
                ...
                <CountdownBox className="z-20 flex justify-center space-x-4" day hour minute second start="05/28/2021 18:00" end="05/31/2021 18:00" />
            </div>
